...
export function AboutSection() {
  return (
    <section className="bg-white py-20 lg:py-24">
      <Container>
        <div className="grid gap-10 lg:grid-cols-[42%_58%] lg:items-stretch lg:gap-12">
          <div className="relative">
            <div className="rounded-card border-border relative aspect-[4/3] w-full overflow-hidden border lg:aspect-auto lg:h-full">
              <Image
