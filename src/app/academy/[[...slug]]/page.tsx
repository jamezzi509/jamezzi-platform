...
export default async function AcademyPage({
  ...
  if (
    ...
    return (
      <ComputerPlatformOnboarding
        firstLessonSlug={computerModuleOneV2[0].slug}
  ...
  if (
    ...
    const rebuiltLesson = getComputerLessonV2(slug[3]);
    if (rebuiltLesson) {
      return (
        <ComputerLessonPlayerV2 key={rebuiltLesson.id} lesson={rebuiltLesson} />
      );
    }
    redirect("/academy/courses/computer-internet-essentials");
  }
